...
$stmt = $db->prepare("SELECT p.title, s.title as schedule_title, s.start_date, s.end_date, s.physical_fee 
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h5 mb-0">Application Form - Physical</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li><strong>Fee:</strong> KES <?= number_format($program_data['physical_fee'], 2) ?></li>
                        </ul>
                    </div>
                </div>
            </div>
