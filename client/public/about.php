...
$leadershipTeam = $db->query("SELECT * FROM team_members ORDER BY position_order")->fetchAll();
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-3"> <!-- Changed from col-4 to col-3 for more compact layout -->
                <div class="card h-100 border-0 shadow-sm">
                    <img src="<?php echo BASE_URL . '/uploads/team/' . htmlspecialchars($member['photo']); ?>" 
                         class="card-img-top" 
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="social-links">
                            <?php if (!empty($member['linkedin'])): ?>
                                <a href="<?php echo htmlspecialchars($member['linkedin']); ?>" target="_blank" class="text-decoration-none me-2">
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                            <?php endif; ?>
                            <?php if (!empty($member['twitter'])): ?>
                                <a href="<?php echo htmlspecialchars($member['twitter']); ?>" target="_blank" class="text-decoration-none me-2">
