                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="delivery_mode" name="delivery_mode">
                            ...
                            <option value="hybrid" <?php echo (isset($_POST['delivery_mode']) && $_POST['delivery_mode'] == 'hybrid') ? 'selected' : ''; ?>>
                                Hybrid
                            </option>
                        </select>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="online_fee" name="online_fee" 
                               value="<?php echo htmlspecialchars($_POST['online_fee'] ?? '0.00'); ?>" 
                               placeholder="0.00">
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="physical_fee" name="physical_fee" 
                               value="<?php echo htmlspecialchars($_POST['physical_fee'] ?? '0.00'); ?>" 
                               placeholder="0.00">
                    </div>
