            ...
            <form method="POST" action="">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="program_id" name="program_id" required>
                            ...
                            <?php foreach ($programs as $program): ?>
                                <option value="<?php echo $program['id']; ?>" <?php echo (isset($_POST['program_id']) ? ($_POST['program_id'] == $program['id']) : ($schedule['program_id'] == $program['id'])) ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title" 
                               value="<?php echo htmlspecialchars($_POST['title'] ?? $schedule['title']); ?>" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="start_date" name="start_date" 
                               value="<?php echo htmlspecialchars($_POST['start_date'] ?? $schedule['start_date']); ?>" required>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="end_date" name="end_date" 
                               value="<?php echo htmlspecialchars($_POST['end_date'] ?? $schedule['end_date']); ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="time" class="form-control" id="start_time" name="start_time" 
                               value="<?php echo htmlspecialchars($_POST['start_time'] ?? $schedule['start_time'] ?? '09:00'); ?>">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="time" class="form-control" id="end_time" name="end_time" 
                               value="<?php echo htmlspecialchars($_POST['end_time'] ?? $schedule['end_time'] ?? '17:00'); ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="location" name="location" 
                               value="<?php echo htmlspecialchars($_POST['location'] ?? $schedule['location'] ?? 'Online'); ?>" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="registration_deadline" name="registration_deadline" 
                               value="<?php echo htmlspecialchars($_POST['registration_deadline'] ?? $schedule['registration_deadline'] ?? ''); ?>">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="instructor_name" name="instructor_name" 
                               value="<?php echo htmlspecialchars($_POST['instructor_name'] ?? $schedule['instructor_name'] ?? ''); ?>" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control" id="instructor_email" name="instructor_email" 
                               value="<?php echo htmlspecialchars($_POST['instructor_email'] ?? $schedule['instructor_email'] ?? ''); ?>" 
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="timezone" name="timezone">
                            <option value="Africa/Nairobi" <?php echo (isset($_POST['timezone']) ? ($_POST['timezone'] == 'Africa/Nairobi') : ($schedule['timezone'] == 'Africa/Nairobi')) ? 'selected' : ''; ?>>
                                Africa/Nairobi (EAT)
                            </option>
                            <option value="UTC" <?php echo (isset($_POST['timezone']) ? ($_POST['timezone'] == 'UTC') : ($schedule['timezone'] == 'UTC')) ? 'selected' : ''; ?>>
                                UTC
                            </option>
                            <option value="Africa/Lagos" <?php echo (isset($_POST['timezone']) ? ($_POST['timezone'] == 'Africa/Lagos') : ($schedule['timezone'] == 'Africa/Lagos')) ? 'selected' : ''; ?>>
                                Africa/Lagos (WAT)
                            </option>
                            <option value="Africa/Johannesburg" <?php echo (isset($_POST['timezone']) ? ($_POST['timezone'] == 'Africa/Johannesburg') : ($schedule['timezone'] == 'Africa/Johannesburg')) ? 'selected' : ''; ?>>
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control" id="meeting_link" name="meeting_link" 
                           value="<?php echo htmlspecialchars($_POST['meeting_link'] ?? $schedule['meeting_link'] ?? ''); ?>" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="meeting_password" name="meeting_password" 
                           value="<?php echo htmlspecialchars($_POST['meeting_password'] ?? $schedule['meeting_password'] ?? ''); ?>" 
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="venue_address" name="venue_address" rows="3" 
                              placeholder="Physical venue address (for in-person sessions)"><?php echo htmlspecialchars($_POST['venue_address'] ?? $schedule['venue_address'] ?? ''); ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="3" 
                              placeholder="Additional details about this schedule"><?php echo htmlspecialchars($_POST['description'] ?? $schedule['description'] ?? ''); ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="session_notes" name="session_notes" rows="3" 
                              placeholder="Internal notes about this schedule"><?php echo htmlspecialchars($_POST['session_notes'] ?? $schedule['session_notes'] ?? ''); ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="requirements" name="requirements" rows="3" 
                              placeholder="Special requirements for this schedule"><?php echo htmlspecialchars($_POST['requirements'] ?? $schedule['requirements'] ?? ''); ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="materials_included" name="materials_included" rows="3" 
                              placeholder="Materials included with this schedule"><?php echo htmlspecialchars($_POST['materials_included'] ?? $schedule['materials_included'] ?? ''); ?></textarea>
                </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" 
                                   <?php echo (isset($_POST['is_active']) ? ($_POST['is_active']) : ($schedule['is_active'])) ? 'checked' : ''; ?>>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="is_open_for_registration" name="is_open_for_registration" value="1" 
                                   <?php echo (isset($_POST['is_open_for_registration']) ? ($_POST['is_open_for_registration']) : ($schedule['is_open_for_registration'])) ? 'checked' : ''; ?>>
