...
// Fetch email campaign data for the report
// This is a placeholder as we don't have a campaigns table yet
$campaigns = [];
?>

<div class="container-fluid px-4">
    <h1 class="mt-4">Email Campaign Performance</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="reports.php">Reports</a></li>
        <li class="breadcrumb-item active">Email Campaign Performance</li>
    </ol>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="alert alert-info">Email campaign tracking is not yet implemented.</div>
