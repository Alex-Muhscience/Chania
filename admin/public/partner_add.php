...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $db->prepare("SELECT id FROM partners WHERE slug = ? AND deleted_at IS NULL");
        $stmt->execute([$slug]);
        if ($stmt->fetch()) {
            throw new Exception('A partner with this slug already exists.');
        }
        
        $sql = "INSERT INTO partners (name, slug, description, logo_path, website_url, contact_email, contact_phone, 
                contact_person, partnership_type, partnership_level, start_date, end_date, is_featured, 
        ...
        $stmt->execute([
            ...
            $is_featured, $is_active, $display_order, $_SESSION['user_id'] ?? null
        ]);
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-handshake fa-fw"></i> Add New Partner
        </h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="4" 
                                      placeholder="Brief description of the partnership and organization"></textarea>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="logo_option" id="logo_upload" value="upload" checked>
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="logo_url_option">
                                    <strong>Use Logo URL</strong>
                                </label>
                            </div>
                        </div>
                        
                        <div id="logo_upload_section">
                            <div class="form-group">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="partnership_type" name="partnership_type">
                                ...
                                <option value="employment">Employment Partner</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="partnership_level" name="partnership_level">
                                ...
                                <option value="standard" selected>Standard Partner</option>
